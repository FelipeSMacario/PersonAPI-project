    ...
    () => {
      const config = {
        data: {
          ...
          descricao: 'Não conseguimos salvar seu registro, favor tentar novamente mais tarte',
          corBtnSucesso: 'warn',
          btnSucesso: 'Fechar'
        } as Alerta
      };
    ...
    () => {
      const config = {
        data: {
          ...
          descricao: 'Não conseguimos editar seu registro, favor tentar novamente mais tarte',
          corBtnSucesso: 'warn',
          btnSucesso: 'Fechar'
        } as Alerta
      };
